...
def main():
    ...
    <div class="report-header">
        <h1 style="margin:0; font-size:2.1rem;">Daily RO Production Report <span style="font-size:1.1rem; opacity:0.9;">v{__version__} <span style="background:#ff4b4b; color:white; padding:2px 8px; border-radius:4px; font-size:0.7rem;">TEST</span></span></h1>
        <p style="margin:8px 0 0 0; opacity:0.95; font-size:1.05rem;">
            ...
            <span style="font-size:0.9rem;">Read-only RO Writer (MSSQL) • Mock mode ready • Direct pyodbc • <b>EXPERIMENTAL</b></span>
        </p>
    </div>
    """, unsafe_allow_html=True)

    # KPI CAST button - forces new tab for Chromecast / TV
    ...
    with cast_col2:
        ...
        """, unsafe_allow_html=True)
        st.caption("Opens clean TV board (port 8502) • Cast that tab to Chromecast/TV")
